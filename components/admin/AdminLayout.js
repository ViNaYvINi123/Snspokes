...
const NAV_GROUPS = [
  ...
  { label: 'Users', items: [
    ...
    { href: '/admin/churn',          label: '📉 Churn Analytics' },
  ...
  { label: 'Content', items: [
    ...
    { href: '/admin/spoke-seeder',   label: '🌱 Seeder' },
    { href: '/admin/spoke-versions', label: '🔖 Versions' },
    { href: '/admin/content-quality',label: '✅ Quality' },
    { href: '/admin/error-encyclopedia', label: '🐛 Error Encyclopedia' },
  ...
  { label: 'System', items: [
    ...
    { href: '/admin/health-timeline', label: '❤️ Health' },
    { href: '/admin/logs',            label: '📋 Logs' },
    { href: '/admin/audit-log',       label: '🔐 Audit Log' },
    { href: '/admin/ip-block',        label: '🛡️ IP Blocking' },
  ...
  { label: 'Config', items: [
    ...
    { href: '/admin/env-manager',    label: '🔒 Env Manager' },
  ...
  { label: 'Tools', items: [
    ...
    { href: '/admin/global-search',  label: '🔍 Global Search' },
    { href: '/admin/api-connectors', label: '🔌 API Connectors' },
  ]},
];
