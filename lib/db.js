...
// With PgBouncer in front: keep pool small, let PgBouncer handle multiplexing
let pool = null;
...
function getPool() {
  ...
  pool = new Pool({
    ...
    max:                  parseInt(process.env.DB_POOL_MAX || '10'),  // PgBouncer multiplexes — keep this small
    min:                  2,
