  ...
  if (!slug || loading) return (
    <>
      ...
      <div style={{ paddingTop: '120px', textAlign: 'center', minHeight: '100vh' }}>
        <div className="spin" style={{ width: '40px', height: '40px', borderRadius: '50%', border: '3px solid #1e1e2e', borderTopColor: '#6c63ff', margin: '0 auto 20px' }} />
        <p style={{ color: '#6b6b8a' }}>Loading spoke details...</p>
        <p style={{ color: '#6b6b8a', fontSize: '12px', marginTop: '8px' }}>First visit may take 30-60 seconds while AI generates content</p>
      </div>
    </>
  );
      ...
      <main style={{ paddingTop: '80px', minHeight: '100vh' }}>
        ...
        <section style={{ padding: '48px 24px', borderBottom: '1px solid #1e1e2e', background: 'linear-gradient(180deg, rgba(108,99,255,0.05) 0%, transparent 100%)' }}>
          <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
            ...
            <div style={{ marginTop: '20px', padding: '10px 16px', background: '#0a0a14', border: '1px solid #1e1e2e', borderRadius: '8px', display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
