...
const NAV_GROUPS = [
  { label: 'Overview', items: [
    ...
    { href: '/admin/global-search', label: 'Global Search', icon: 'Search' },
  ]},
  { label: 'Catalog', items: [
    { href: '/admin/spokes', label: 'Spokes', icon: 'Spokes' },
    { href: '/admin/spoke-seeder', label: 'Content Seeder', icon: 'Seed' },
    { href: '/admin/properties', label: 'SN Properties', icon: 'Properties' },
    { href: '/admin/flags', label: 'Feature Flags', icon: 'Flags' },
  ]},
  { label: 'Developer Tools', items: [
    { href: '/tools/query-builder', label: 'Query Builder', icon: 'Query' },
    { href: '/tools/error-finder', label: 'Error Finder', icon: 'Error' },
    { href: '/tools/version-matrix', label: 'Version Matrix', icon: 'Matrix' },
    { href: '/tools/code-generator', label: 'AI Code Gen', icon: 'AI' },
    { href: '/tools/script-linter', label: 'Script Linter', icon: 'Lint' },
  ]},

  { label: 'Integrations', items: [
    { href: '/admin/api-connectors', label: 'API Connectors', icon: 'API' },
  ]},
  ...
  { label: 'Content', items: [
    { href: '/admin/content-quality', label: 'Content Quality', icon: 'Quality' },
    { href: '/admin/announcements', label: 'Announcements', icon: 'Announce' },
  ]},
  { label: 'System', items: [
    { href: '/admin/database', label: 'Database', icon: 'Database' },
    { href: '/admin/env-manager', label: 'Env Manager', icon: 'Env' },
    { href: '/admin/ai-debug', label: 'AI Debug', icon: 'AI' },
    { href: '/admin/logs', label: 'Activity Logs', icon: 'Logs' },
    { href: '/admin/settings', label: 'Settings', icon: 'Settings' },
    { href: '/admin/backup', label: 'DB Backup', icon: 'Backup' },
  ]},
];
          ...
          {!collapsed ? (
            <>
              <Link href="/" target="_blank" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '9px' }}>
                ...
                <div>
                  <div style={{ fontSize: '13px', fontWeight: '700', color: '#111827', letterSpacing: '-0.2px', whiteSpace: 'nowrap' }}>snspokes</div>
