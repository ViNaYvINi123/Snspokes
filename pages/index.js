...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>snspokes — ServiceNow Integration Hub Directory</title>
        <meta name="description" content="Search 500+ ServiceNow spokes, generate production-ready code with AI, debug errors instantly. The #1 resource for ServiceNow developers." />
        <meta name="keywords" content="ServiceNow, Integration Hub, Spokes, Flow Designer, GlideRecord" />
        <meta property="og:title" content="snspokes — ServiceNow Integration Hub Directory" />
        <meta property="og:description" content="Search 500+ ServiceNow spokes, generate AI code, debug errors. The #1 resource for ServiceNow developers." />
