...
function generateSitemap(spokes) {
  const staticPages = [
    ...
    { url: '/tools/script-linter', priority: '0.7', changefreq: 'weekly' },
    { url: '/tools/error-finder', priority: '0.7', changefreq: 'weekly' },
    { url: '/tools/query-builder', priority: '0.7', changefreq: 'weekly' },
    { url: '/tools/version-matrix', priority: '0.7', changefreq: 'weekly' },
